...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ...
        ensures
            - Converts(×ª»») the HOG filters in the given detector (specifically, the filters in
              ...
              way that shows the magnitude(Á¿¼¶) and orientation of the gradient energy in each
